...
//    LANG_MOVEGENS_FOLLOW_NULL           = 1134,
    ...
    // Name Announce 12 RANGS
    LANG_SYSTEMMESSAGE_VIP               = 1350,
    LANG_SYSTEMMESSAGE_MODERATOR         = 1351,
    LANG_SYSTEMMESSAGE_MODERATORCHIEF    = 1352,
    LANG_SYSTEMMESSAGE_GAMEOPERATOR      = 1353,
    LANG_SYSTEMMESSAGE_SUPERGAMEOPERATOR = 1354,
    LANG_SYSTEMMESSAGE_GAMEMASTER        = 1355,
    LANG_SYSTEMMESSAGE_SUPERGAMEMASTER   = 1356,
    LANG_SYSTEMMESSAGE_QUALITYASSURANCE  = 1357,
    LANG_SYSTEMMESSAGE_DEVELOPER         = 1358,
    LANG_SYSTEMMESSAGE_GAMECHIEF         = 1359,
    LANG_SYSTEMMESSAGE_SUBADMINISTRATOR  = 1360,
    LANG_SYSTEMMESSAGE_ADMINISTRATOR     = 1361,
